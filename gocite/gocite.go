// this module is a copy from github.com/ThomasK81/gocite
// at the moment of this program was written, the module was not correctly compiled in repository
// it is functions to work with CTS URN
package gocite
