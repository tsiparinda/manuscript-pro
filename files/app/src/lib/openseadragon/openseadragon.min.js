...
!(function (r) {
  ...
  r.EventSource.prototype = {
    ...
    addHandler: function (e, t, i) {
      ...
      t &&
        r.isFunction(t) &&
        (n[n.length] = { handler: t, userData: i || null })
    },
    ...
    if (0 === n) {
      ...
      if (t.preventGesture || t.defaultPrevented) {
        ...
        if (1 === s.contacts)
          ...
          r.lastPinchDist = r.currentPinchDist = r.pinchGPoints[0].currentPos.distanceTo(
...
!(function (m) {
  ...
  m.Viewer = function (e) {
    ...
    this.innerTracker = new m.MouseTracker({
      ...
      scrollHandler: m.delegate(this, D),
    ...
    this.outerTracker = new m.MouseTracker({
      ...
      dblClickTimeThreshold: this.dblClickTimeThreshold,
      dblClickDistThreshold: this.dblClickDistThreshold,
      enterHandler: m.delegate(this, I),
      leaveHandler: m.delegate(this, O),
    })
    this.toolbar &&
    ...
    this.world.addHandler('add-item', function (e) {
      ...
      n._updateRequestId || (n._updateRequestId = a(n, k))
    })
    ...
    m.ControlDock.prototype,
    {
      ...
      addTiledImage: function (i) {
        ...
        void 0 === i.crossOriginPolicy &&
          (i.crossOriginPolicy = (void 0 !== i.tileSource.crossOriginPolicy
            ? i.tileSource
            : this
          ).crossOriginPolicy)
        ...
        void 0 === i.ajaxHeaders || null === i.ajaxHeaders
          ? (i.ajaxHeaders = this.ajaxHeaders)
          : m.isPlainObject(i.ajaxHeaders) &&
            m.isPlainObject(this.ajaxHeaders) &&
            (i.ajaxHeaders = m.extend({}, this.ajaxHeaders, i.ajaxHeaders))
        var o = { options: i }
        function t(e) {
              ...
              if ('string' === m.type(n))
                ...
                void 0 !== n.crossOriginPolicy ||
                  (void 0 === o.crossOriginPolicy &&
                    void 0 === i.crossOriginPolicy) ||
                  (n.crossOriginPolicy = (void 0 !== o.crossOriginPolicy
                    ? o
                    : i
                  ).crossOriginPolicy)
      ...
      bindStandardControls: function () {
        ...
        if (this.showNavigationControl) {
          ...
          if (g) {
            ...
            this.addHandler('open', m.delegate(this, N))
  ...
  function b(e) {
    ...
    if (this.viewport) {
      if (
        (t = this.gestureSettingsByDeviceType(e.pointerType)).pinchToZoom &&
      ...
      if (t.pinchRotate && !o.preventDefaultRotateAction) {
        ...
        this.viewport.setRotation(
          this.viewport.getRotation() + (o - e) * (180 / Math.PI)
        )
      }
    }
  }
  ...
  function k(e) {
    ...
    e.isOpen() ? (e._updateRequestId = a(e, k)) : (e._updateRequestId = !1)
  }
  function B(e, t) {
    return e ? e + t : t
  }
  ...
  h.extend(h.IIIFTileSource.prototype, h.TileSource.prototype, {
    ...
    getTileAtPoint: function (e, t) {
      return this.emulateLegacyImagePyramid
        ? new h.Point(0, 0)
        : h.TileSource.prototype.getTileAtPoint.call(this, e, t)
    },
    getTileUrl: function (e, t, i) {
      if (this.emulateLegacyImagePyramid) {
        var n = null
      ...
      var o,
        ...
        a,
        l,
        h = Math.pow(0.5, this.maxLevel - e),
        c = Math.round(this.width * h),
        u = Math.round(this.height * h)
      ...
      if (c < o && u < r) {
        ...
        s =
          0 === t && 0 === i && l === this.width && n === this.height
            ? 'full'
            : [u, c, l, n].join(',')
        l = Math.round(l * h)
        h = Math.round(n * h)
        a =
          2 === this.version && l === this.width
            ? 'full'
            : 3 === this.version && l === this.width && h === this.height
            ? 'max'
            : 3 === this.version
            ? l + ',' + h
            : l + ','
      }
      return [this._id, s, a, '0', e].join('/')
    },
...
!(function (a) {
  ...
  a.extend(a.ImageTileSource.prototype, a.TileSource.prototype, {
    ...
    getContext2D: function (e, t, i) {
      var n = null
      return (n =
        e >= this.minLevel && e <= this.maxLevel ? this.levels[e].context2D : n)
    },
    destroy: function () {
...
!(function (n) {
  n.ImageJob = function (e) {
    n.extend(!0, this, { timeout: n.DEFAULT_SETTINGS.timeout, jobId: null }, e)
    this.data = null
    this.userData = {}
    this.errorMsg = null
  }
...
!(function (h) {
  ...
  h.Viewport.prototype = {
    ...
    zoomTo: function (e, t, i) {
      ...
      this.viewer &&
        this.viewer.raiseEvent('zoom', { zoom: e, refPoint: t, immediately: i })
      return this
    },
...
!(function (y) {
  ...
  y.extend(y.TiledImage.prototype, y.EventSource.prototype, {
    ...
    setPosition: function (e, t) {
      var i =
        this._xSpring.target.value === e.x && this._ySpring.target.value === e.y
      if (t) {
        if (
          i &&
    ...
    _setTileLoaded: function (e, t, i, n) {
      ...
      function a() {
        if (0 === --o) {
          e.loading = !1
          e.loaded = !0
          e.hasTransparency = r.source.hasTransparency(
            e.context2D,
            e.getUrl(),
            e.ajaxHeaders,
            e.postData
